...
typedef enum {
	...
	j9gc_modron_configuration_heapBase, /* Return the base of the heap */
	j9gc_modron_configuration_heapRegionShift, /* a pointer to the base of the region state table */
